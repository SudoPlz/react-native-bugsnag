...
export default class RNBugsnag {
  ...
  constructor( props ) {
    ...
    instance.suppressDevErrors = (!!props && props.suppressDevErrors===true);
  ...
  async wrapGlobalHandler(error, isFatal){
    ...
    if(instance.suppressDevErrors===true){  //if the user does not want to trigger error reporting while on dev/debug mode
