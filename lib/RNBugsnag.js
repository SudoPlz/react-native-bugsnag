...
export default class RNBugsnag {
  ...
  async constructor( props ) {
    ...
    await NativeBugsnag.init(); //init our native part 
    return instance;
  }
  ...
  //TODO: Create native responder
  async notify(exceptionTitle, exceptionReason, severity){
    return await NativeBugsnag.notify(exceptionTitle, exceptionReason, severity);
  }
