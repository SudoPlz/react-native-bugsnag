...
RCT_EXPORT_METHOD(notify:(NSString *)name reason:(NSString *)reason userInfo:(NSDictionary *)userInfo)
{
  [Bugsnag notify:[NSException exceptionWithName:name reason:reason userInfo:userInfo]];
}
